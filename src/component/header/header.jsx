            ...
            <div className="row w-100">
              <div className="col-md-8">
                <ul className="navbar-nav me-auto mb-2 mb-lg-0 d-flex justify-content-evenly align-items-center">
                  ...
                  <li className="nav-item">
                    <Link to="/doc" className="nav-link active color_nav" aria-current="page">
                      Tài liệu
                    </Link>
                  </li>
                  <li className="nav-item dropdown">
                    <a className="nav-link dropdown-toggle color_nav" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" onClick={()=>setOpen(p=>!p)}>
                      Mua ngay
                    </a>
                    {
                      open && (
              ...
              <div className="col-md-4 d-flex justify-content-start">
                ...
                <button className="btn border btn-outline-custom" onClick={onhangdleLogin}>Đăng nhập</button>
              </div>
            </div>
          </div>
        </nav>
