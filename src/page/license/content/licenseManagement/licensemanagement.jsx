...
export function LicenseManagementPage() {
  const hasContent = dataLicenseMGN.some((item) => item.content);
    ...
    <div className="container pt-5">
      ...
      <div className="row mt-4">
        <div className="col-md-12">
          <div className="border p-3 rounded" style={{ backgroundColor: "#ffffe3" }}>
      ...
      <div className="row mt-4">
        <div className="col-md-12">
          <div className="border p-3 rounded" style={{ backgroundColor: "#d7ebff", color: "#0080c0" }}>
            Nhấn vào biểu tượng
            <img className="px-2" src={iconArrowWarning} alt="" />nếu bạn muốn kích
            hoạt thêm module hoặc thiết bị cho License. <br />
            Mật khẩu giải nén / cài đặt của tất cả phần mềm là : <b>3am.vn</b>{" "}
            hoặc <b>3am.net</b>
          </div>
        </div>
        <div className="mt-4">
              ...
              <table className="table table-bordered text-center">
                ...
                <tbody>
                  <tr>
                    {hasContent ? (
                      dataLicenseMGN.map((item, index) => (
                        <td key={index} className='text-start' data-title={item.title}>
                          {item.content}
                        </td>
                      ))
                    ) : (
